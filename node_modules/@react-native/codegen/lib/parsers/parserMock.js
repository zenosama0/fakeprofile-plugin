...
} = require('./flow/parseFlowAndThrowErrors');
const {
  buildPropSchema
...
export class MockedParser {
  ...
  getTypeAnnotationName(typeAnnotation) {
    ...
    return typeAnnotation === null || typeAnnotation === void 0 || (_typeAnnotation$id = typeAnnotation.id) === null || _typeAnnotation$id === void 0 ? void 0 : _typeAnnotation$id.name;
  }
