...
function combineSchemas(files, libraryName) {
  const combined = files.reduce((merged, filename) => {
...
function combineSchemasInFileList(fileList, platform, exclude, libraryName) {
  const expandedFileList = expandDirectoriesIntoFiles(fileList, platform, exclude);
...
function combineSchemasInFileListAndWriteToFile(fileList, platform, outfile, exclude, libraryName) {
  const combined = combineSchemasInFileList(fileList, platform, exclude, libraryName);
