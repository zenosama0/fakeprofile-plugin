...
module.exports = {
  generate(libraryName, schema, packageName, assumeNonnull = false, headerPrefix) {
    ...
    Object.keys(nativeModules).forEach(hasteModuleName => {
      ...
      const imports = new Set(['com.facebook.react.bridge.ReactApplicationContext', 'com.facebook.react.bridge.ReactContextBaseJavaModule', 'com.facebook.react.bridge.ReactMethod', 'com.facebook.react.turbomodule.core.interfaces.TurboModule', 'com.facebook.proguard.annotations.DoNotStrip', 'javax.annotation.Nonnull']);
      const methods = spec.methods.map(method => {
        ...
        const isSyncMethod = methodTypeAnnotation.returnTypeAnnotation.type !== 'VoidTypeAnnotation' && !returningPromise;
      ...
      files.set(`${outputDir}/${className}.java`, FileTemplate({
        ...
        className,
        jsName: moduleName,
        eventEmitters: spec.eventEmitters.map(eventEmitter => EventEmitterTemplate(eventEmitter, imports)).join('\n\n'),
